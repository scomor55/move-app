import com.example.cineasteapp.Movie
import com.example.cineasteapp.getFavoriteMovies
import com.example.cineasteapp.getRecentMovies
import org.junit.Assert.assertEquals
import org.junit.Test

class MovieStaticDataTest {
    ...
    fun testGetFavoriteMovies() {
        val expectedMovies = listOf(
            ...
            Movie(4,"Top Gun: Maverick",
                ...
                "drama")
            // Add more expected movies as needed
        )

        val actualMovies = getFavoriteMovies()
    ...
    fun testGetRecentMovies() {
        ...
        val actualMovies = getRecentMovies()
        assertEquals(expectedMovies, actualMovies)
    }
}